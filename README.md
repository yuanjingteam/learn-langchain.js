...
- [ ] [**5.0** 工具调用](https://github.com/yuanjingteam/learn-langchain.js/tree/5.0)               | Function Calling、自定义工具、API 接入（搜索/数据库/计算）
- [ ] [**6.0** 决策系统](https://github.com/yuanjingteam/learn-langchain.js/tree/6.0)               | ReAct 模式、Tool Calling Agent、Plan & Execute
- [ ] [**7.0** 记忆系统](https://github.com/yuanjingteam/learn-langchain.js/tree/7.0)                | 对话历史管理、上下文窗口、长期记忆存储
- [ ] [**8.0** RAG 全流程](https://github.com/yuanjingteam/learn-langchain.js/tree/8.0)           | 文档加载、向量存储、检索增强生成、知识库问答
...
深入探索 Function Calling 的高级用法，实现自定义工具和外部 API 接入。

**计划内容：**

- **Function Calling**：掌握模型原生工具调用机制，理解工具描述与参数约束
- **自定义工具**：使用 `tool()` + Zod 定义业务工具，实现复杂业务逻辑封装
- **API 接入实战**：
  - 搜索 API：集成 Tavily / SerpAPI 实现实时信息检索
  - 数据库 API：连接 SQLite / PostgreSQL 实现数据查询
  - 计算 API：调用 Wolfram Alpha 实现数学计算
