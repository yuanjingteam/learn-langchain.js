...
- [X] [**5.0** 决策系统](https://github.com/yuanjingteam/learn-langchain.js/tree/6.0)               | ReAct 模式、Tool Calling Agent、Plan & Execute
- [X] [**6.0** 记忆系统](https://github.com/yuanjingteam/learn-langchain.js/tree/7.0)                | 对话历史管理、上下文窗口、长期记忆存储
